...
def test_done_checkbox() -> None:
    line = render_task_line("book the room", id="t_9f0e", created=date(2026, 7, 27), done=True)
    assert line == "- [x] book the room <!-- id:t_9f0e created:2026-07-27 -->"


def test_omits_empty_type_and_tags() -> None:
    line = render_task_line("buy milk", id="t_5c31")
    assert line == "- [ ] buy milk <!-- id:t_5c31 -->"
