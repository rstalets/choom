...
from choom.core.editing import load_for_edit
...
from choom.core.mirrors import reconcile_on_open, write_document
from choom.core.models import Document, Link, LinkStatus, LinkTarget, Workspace
from choom.tui.rendering import (
    NO_INBOUND_LINKS,
    NO_OUTBOUND_LINKS,
    render_link_row,
    render_preview_markdown,
)
from choom.tui.status_bar import LINKS_SECTION_HELP, PREVIEW_HELP, StatusBar
...
class PreviewScreen(Screen[None]):
    ...
    def on_markdown_link_clicked(self, event: Markdown.LinkClicked) -> None:
        ...
        choom owns is opened here instead; anything else (an `https:` URL a
