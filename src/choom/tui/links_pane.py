...
from choom.core.links import inbound_links, outbound_links, resolve_id, resolve_link
from choom.core.models import Link, LinkStatus, LinkTarget, Workspace
from choom.tui.rendering import NO_INBOUND_LINKS, NO_OUTBOUND_LINKS, render_link_row
...
def describe_link_source(workspace: Workspace, link: Link) -> LinkTarget:
    ...
    is not itself a record choom can resolve, so a row always renders.
    """
