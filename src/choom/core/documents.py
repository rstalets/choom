...
from choom.core.text import matches_terms, new_document_id, parse_tags, slugify
...
def create_document(
    ...
    *,
    ...
    if normalized_type in collection.reserved_types:
        raise UsageError(
            f"type '{normalized_type}' is reserved; use 'choom note today' for the daily note"
        )
